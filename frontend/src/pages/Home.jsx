            ...
            <div className="flex flex-col gap-6 md:gap-10">
              ...
              <div>
                <p className="leading-7 md:leading-9 text-sm md:text-md">
                  ...
                  bersama Sdr. Mohamad Faiz sebagai Sekjend DPP SP-BTN. Pada
                  Tahun 2022, DPP SP-BTN mengalami kekosongan kepemimpinan
                  setelah beberapa pengurus wafat. Selanjutnya untuk
                  menyalamatkan organisasi dilakukan Musyawarah Nasional Luar
                  Biasa secara hybrid di Bekasi. Pada forum tersebut terpilih
                  Sdr. Rizky Novriady sebagai Ketua Umum dan Sdr. Ugroseno
                  Bagaskoro sebagai Sekretaris Jendral untuk Periode 2022 -
                  2026.
                </p>
              </div>
              <Link
        ...
        <div className="min-h-screen py-10 md:py-16 px-5 md:px-8 flex flex-col items-center justify-center bg-gray-100">
          <div className="max-w-3xl md:max-w-5xl text-center">
            ...
            <p className="text-gray-600 mt-2 text-base md:text-lg">
              Membangun Serikat Pekerja yang Independen, Representatif dan
              Dinamis untuk Mewujudkan Kesejahteraan Pekerja yang Berimbang.
            </p>
          </div>
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl md:max-w-5xl mx-auto">
            <div className="bg-white/80 shadow-2xl backdrop-blur-md rounded-xl p-6 transform transition-all duration-300 hover:scale-105">
              ...
              <p className="text-gray-700 mt-2 leading-relaxed text-sm md:text-base">
                ...
                keberlanjutan kejayaan BTN dan peningkatan kesejahteraan
                Pekerja.
              </p>
            </div>
            <div className="bg-white/80 shadow-2xl backdrop-blur-md rounded-xl p-6 transform transition-all duration-300 hover:scale-105">
